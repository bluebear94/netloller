static const char *tshirt_colors[] = {
  "white", "black", "gray", "brown",
  "red", "green", "pink", "periwinkle",
  "orange", "yellow", "blue", "purple",
  "light blue", "tangerine", "wisteria", "scarlet",
  "green-yellow", "blue-green", "magenta", "dandelion",
...
static const char* tshirt_images[] = {
